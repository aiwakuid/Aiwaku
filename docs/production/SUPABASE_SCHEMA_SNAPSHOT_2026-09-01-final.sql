...
CREATE OR REPLACE FUNCTION "public"."claim_wa_message_atomic"("p_message_id" "uuid", "p_lease_seconds" integer DEFAULT 60) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."claim_wa_message_atomic"("p_message_id" "uuid", "p_lease_seconds" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."finish_wa_message_atomic"("p_message_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."finish_wa_message_atomic"("p_message_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."register_tenant_atomic"("p_tenant_name" "text", "p_slug" "text", "p_niche" "text", "p_owner_name" "text" DEFAULT NULL::"text", "p_wa_number" "text" DEFAULT NULL::"text", "p_features" "text"[] DEFAULT '{}'::"text"[], "p_niche_label" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
declare
...
ALTER FUNCTION "public"."register_tenant_atomic"("p_tenant_name" "text", "p_slug" "text", "p_niche" "text", "p_owner_name" "text", "p_wa_number" "text", "p_features" "text"[], "p_niche_label" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."retry_wa_message_atomic"("p_message_id" "uuid", "p_error" "text", "p_max_attempts" integer DEFAULT 5) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."retry_wa_message_atomic"("p_message_id" "uuid", "p_error" "text", "p_max_attempts" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."wa_messages" (
    ...
    CONSTRAINT "wa_messages_processing_status_check" CHECK (("processing_status" = ANY (ARRAY['pending'::"text", 'processing'::"text", 'done'::"text", 'failed'::"text"])))
);
...
CREATE INDEX "orders_wa_conversation_idx" ON "public"."orders" USING "btree" ("wa_conversation_id") WHERE ("wa_conversation_id" IS NOT NULL);
...
CREATE INDEX "wa_messages_processing_queue_idx" ON "public"."wa_messages" USING "btree" ("tenant_id", "processing_status", "created_at") WHERE ("direction" = 'inbound'::"text");



CREATE UNIQUE INDEX "wa_messages_tenant_provider_msg_idx" ON "public"."wa_messages" USING "btree" ("tenant_id", "provider_message_id") WHERE ("provider_message_id" IS NOT NULL);
...
ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_wa_conversation_id_fkey" FOREIGN KEY ("wa_conversation_id") REFERENCES "public"."wa_conversations"("id") ON DELETE SET NULL;
...
REVOKE ALL ON FUNCTION "public"."claim_wa_message_atomic"("p_message_id" "uuid", "p_lease_seconds" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."claim_wa_message_atomic"("p_message_id" "uuid", "p_lease_seconds" integer) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."finish_wa_message_atomic"("p_message_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."finish_wa_message_atomic"("p_message_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."register_tenant_atomic"("p_tenant_name" "text", "p_slug" "text", "p_niche" "text", "p_owner_name" "text", "p_wa_number" "text", "p_features" "text"[], "p_niche_label" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."register_tenant_atomic"("p_tenant_name" "text", "p_slug" "text", "p_niche" "text", "p_owner_name" "text", "p_wa_number" "text", "p_features" "text"[], "p_niche_label" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."register_tenant_atomic"("p_tenant_name" "text", "p_slug" "text", "p_niche" "text", "p_owner_name" "text", "p_wa_number" "text", "p_features" "text"[], "p_niche_label" "text") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."retry_wa_message_atomic"("p_message_id" "uuid", "p_error" "text", "p_max_attempts" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."retry_wa_message_atomic"("p_message_id" "uuid", "p_error" "text", "p_max_attempts" integer) TO "service_role";
